    ...
    async execute(message, args, Embed, Discord, Tags, tag) {
        ...
        if (args[0] == "aktif") {
            ...
            const infoEmbed = new Discord.MessageEmbed()
                ...
                .setColor("#b6ffa6")
                .setDescription("Sunucuya Katılan Oyunculara Otomatik Rol Verir..\n\u200b")
                .addFields(
                    { name: `Gereken Yetki:`, value: "Yönetici", inline: true },
                    { name: `${prefix}otorol rol @rol`, value: "Otomatik Verilecek Rolü Belirler." },
                    { name: `${prefix}otorol aktif`, value: "Otomatik Rolü Aktifleştirir." },
                    { name: `${prefix}otorol pasif`, value: "Otomatik Rolü Pasifleştirir." },
                )
